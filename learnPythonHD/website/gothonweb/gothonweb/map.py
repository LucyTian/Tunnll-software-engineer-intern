...
"""The Gothon of Planet Percal #25 have invaded your ship and destroyed
...
jumps out, read scaly skin, dark grimy teeth, and evil clown costume
...
laser_weapon_armory.add_paths({
    '0132': the_bridge,
    '*': generic_death # cath-all action in the engine
})
